...
<body>
  ...
  <div style="position: fixed; bottom: 16px; right: 16px; z-index: 9999; font-size: 10px; color: rgba(225, 74, 139, 0.7); font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; pointer-events: none;">
...
generateProductLaunch.defaults = {
  ...
  slides: [
    { 
      ...
      content: 'The workspace that thinks ahead',
      type: 'title'
    },
    { 
    ...
    { 
      ...
      type: 'stats',
      data: [
        { value: '42%', label: 'Faster delivery', change: '+15%' },
        { value: '3.2x', label: 'Team satisfaction', change: '+180%' },
        { value: '$240K', label: 'Annual savings', change: '' },
        { value: '48hrs', label: 'Onboarding time', change: '-85%' }
      ]
    },
    { 
      title: 'What Our Beta Users Say', 
      content: 'AcmeFlow is like having a brilliant assistant who never sleeps. It knows what I need before I do.\nSarah Chen, Head of Product at TechCorp',
      type: 'quote'
    },
    { 
